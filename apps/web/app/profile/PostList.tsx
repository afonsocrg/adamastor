    ...
    <div className="space-y-4">
      {posts?.length === 0 ? (
        ...
        posts?.map((post) => (
          ...
          >
            <h2 className="text-xl font-semibold text-neutral-900 flex-1 truncate">{post.title}</h2>
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem
                  onSelect={() => navigator.clipboard.writeText(window.location.origin + `/posts/${post.id}`)}
