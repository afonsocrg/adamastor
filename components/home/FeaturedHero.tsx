...
import { getDisplayTitle, getKickerLabel, getPostKind, getWeekLabel } from "@/lib/posts/kind";
 ...
 *   - Weekly: kicker carries "The Adamastor Weekly · Week N"; Carlos's
 *     canonical role line under the byline. No portrait — repeating Carlos
 *     every Tuesday would feel like wallpaper.
 *   - Opinion: kicker is "Opinion"; small duotone author portrait + role
 *     line derived from the bio's first sentence.
 *
		...
		<article className="group border-b border-navy-frame pb-10 dark:border-cyan-glow/[0.12]">
			...
			>
				<div className="flex items-center justify-between gap-3">
					{/* Opinion kicker carries the page's one warm-accent moment — orange
					    signals "named voice / personal take." Weekly stays in the navy
					    register because it's the publication's editorial backbone. */}
					<p
					...
					<p className="shrink-0 text-xs font-medium tracking-[0.04em] text-muted-foreground/80">
