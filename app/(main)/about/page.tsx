...
const aboutPageJsonLd = {
	...
	url: `${SITE_URL}/about`,
	description:
		"Since 2017, Carlos Resende has written a weekly read on Portugal’s startup scene, originally as the Techstars StartUp Digest Portugal and now as the Adamastor Weekly. Plus opinion from contributors across the ecosystem like Productized, Fx2 Group, and Startup Portugal.",
	mainEntity: {
		"@type": "Organization",
		...
		founder: [
			{
				...
				description:
					"Co-founder of Adamastor and author of the Adamastor Weekly, which Carlos has curated since 2017, originally as the Techstars StartUp Digest Portugal. Co-founder of Founder Institute Portugal. Expert Evaluator for the European Commission. Two decades of work in startup funding and finance.",
			},
			{
				"@type": "Person",
...
export const metadata: Metadata = {
	...
	description:
		"Carlos Resende has written a weekly read on Portugal’s startup scene since 2017, now as the Adamastor Weekly. Plus opinion from contributors across the ecosystem like Productized, Fx2 Group, and Startup Portugal.",
		...
		<div className="mx-auto max-w-screen-lg space-y-16 md:p-4">
			...
			*/}
			...
			{/*
				...
				streams that define Adamastor's output. The Adamastor Weekly is
				...
				<div className="grid gap-10 md:grid-cols-2">
					<article className="space-y-3">
						...
						<p className="max-w-[55ch] text-base leading-relaxed text-foreground">
							...
							Techstars StartUp Digest Portugal. In 2025, that work evolved into the Adamastor Weekly. The raises,
