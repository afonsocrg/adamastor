...
export default function EventsPageClient({
	...
	// Active = navy-bold with a navy underline — architectural, the same
	// grammar as the site-level Articles / Events nav.
													...
													<div className="mt-3 space-y-3 text-sm leading-relaxed text-navy-tone dark:text-cyan-dim">
														<p>
															...
															>
																...
																<span
																	key={copiedSlackCmd ? "copied" : "idle"}
																	className="state-crossfade inline-flex"
																>
																	{copiedSlackCmd ? (
