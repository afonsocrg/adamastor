...
import { Calendar, type ToolbarProps, type View, momentLocalizer } from "react-big-calendar";
...
${event.description ? `\nDescription: ${event.description}` : ""}
	...
	return (
		<div className="space-y-4">
			<div style={{ height: "800px", width: "100%" }} className="bg-white dark:bg-background rounded-lg p-4">
				<Calendar
					localizer={localizer}
					events={events}
					startAccessor="start"
